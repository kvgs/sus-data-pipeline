...
SELECT
    ...
    SEXO                                         AS sexo,
    TRY_CAST(TRIM(IDADE) AS INT)                 AS idade,
    ...
    TRY_CAST(TRIM(DIAS_PERM) AS INT)             AS dias_internacao,
    TRY_CAST(TRIM(MORTE) AS INT)                 AS obito,
    TRY_CAST(TRIM(VAL_TOT) AS DOUBLE)            AS valor_total,
    TRY_CAST(TRIM(VAL_SH) AS DOUBLE)             AS valor_servicos_hospitalares,
    TRY_CAST(TRIM(VAL_SP) AS DOUBLE)             AS valor_servicos_profissionais,
    TRY_CAST(TRIM(UTI_MES_TO) AS INT)            AS dias_uti,
